...
typedef struct {
   ...
   * @param receivedLength Puntero donde se almacenará la cantidad de bytes
   * leídos realmente.
   * @return status_t STATUS_OK si hay datos leídos, STATUS_BUSY/ERROR en caso
   * contrario.
   */
  status_t (*receive)(uint8_t *data, uint16_t maxLength,
